...
const ChaseSpacePage = () => {
  const tabNames = [
    ...
    { image: CrudIcon, name: "Trip CRUD", video: null },
  ...
  const goalAndSolution = [
    ...
    {
      text: "The Solution was to develop a mobile app with a team of 4. As a team we successfully implemented user roles (Buyers and Travelers), authentication, integrated Escrow API, CRUD functionality for Travellers and Buyers, Real-time private messaging, reviews, feedback, user profiles and edited database design schema.",
    },
  ];
