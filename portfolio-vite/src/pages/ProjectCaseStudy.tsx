            ...
            <AnimateText>
              <div className={styles.square_container}>
                {goalAndSolution?.map((x, index) => {
                  return (
                    <div
                      className={styles.square_container_content}
                      key={index}
                    >
                      <p>{x.text}</p>
                    </div>
              ...
              <div className={styles.left_content}>
                {achievements?.map((x, index) => (
                  ...
                  >
                    ...
                    <p
                      className={open === x.title ? styles.show : styles.hidden}
                    >
                      {x.description}
                    </p>
          ...
          <div className={styles.conclusion_header}>
            <div>
              ...
              <p>
                ...
                services, involving tasks such as expectation management,
                regular communication via emails and Zoom meetings, and
                collaboration within a team. The collaborative nature of
                discussing code, brainstorming ideas, and overcoming challenges
                as a group stood out as a significant reason for my enjoyment
                and reaffirmed my passion for the industry.
              </p>
            </div>
          </div>
          ...
          <div className={styles.carousel}>
            <div className={styles.carousel_contents}>
              ...
              {lessonsLearnt?.map((x, index) => {
                return (
                  <div
                    className={styles.carousel_contents_container}
                    key={index}
                  >
                    <div>
          ...
          <div className={styles.conclusion_header}>
            <div>
              <p>
                ...
                sincere thanks to my supervisor, Peter, for his guidance,
                support, and expertise. I also extend this thanks to my clients,
                Diana, and Stephen, who provided the team with an opportunity to
                test our capabilities and expand our portfolio of knowledge. I
                sincerely enjoyed this collaborative journey and thankful for
